        ...
        <component name="Microsoft-Windows-Shell-Setup" processorArchitecture="amd64" publicKeyToken="31bf3856ad364e35" language="neutral" versionScope="nonSxS" xmlns:wcm="http://schemas.microsoft.com/WMIConfig/2002/State" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
            ...
            <FirstLogonCommands>
                <SynchronousCommand wcm:action="add">
                    <CommandLine>powershell New-NetIPAddress –InterfaceAlias "Ethernet" –IPAddress "{{replica_dc_static_ip}}" –PrefixLength 24 -DefaultGateway {{replica_dc_default_gw}}</CommandLine>
                    <Description>Set new static IP</Description>
                    <Order>1</Order>
                </SynchronousCommand>
                <SynchronousCommand wcm:action="add">
                    <CommandLine>powershell Set-DnsClientServerAddress –InterfaceAlias "Ethernet" -ServerAddresses ("8.8.4.4","8.8.8.8")</CommandLine>
